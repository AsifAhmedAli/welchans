...
<body style="background-color: #f47e4a !important;">
    <div class="container">
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 mx-auto">
                                ...
                                // echo $logoname;
                                ?>
                                    <div class="text-center mb-4"><img src="<?php echo $logoname; ?>" style="max-width: 140px;"></div>
                                    <form class="user" id="adminloginform">
                                        <div class="form-group"><input class="form-control form-control-user" type="text" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Username..." name="email"></div>
                                        ...
                                        </div><button class="btn btn-primary btn-block text-white btn-user" style="background-color: #f47e4a;border: 1px solid #f47e4a;" type="submit">Login</button>
                                    </form>
