...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background-color: #f47e4a !important;background-image: none  !important;">
                ...
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid">
                        <div class="ml-auto d-none d-sm-block">
                            ...
                            ?>
                            <img src="<?php echo $logoname; ?>" style="max-width: 80px;">
                        ...
                        <ul class="navbar-nav flex-nowrap ml-auto">
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"><span class="d-none d-lg-inline mr-2 text-gray-600 small"><?php echo $_SESSION['username']; ?></span><img class="border rounded-circle img-profile" src="<?php echo $logoname; ?>"></a>
                                </div>
                            </li>
    ...
    <script>
        function ajax_call_update_logo(){
